            ...
            <div class="container text-center mt-3">
              <div class="col">
                ...
                if (isset($_SESSION['id'])) {
                  ...
                  $query = "SELECT id,email, nama, gambar FROM user_login WHERE id = $user_id"; // Sesuaikan dengan struktur tabel dan kolom kamu
                  ...
                  if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<a href='edit_data.php?id=" .$user_id. "' class='btn btn-primary'><i class='fa fa-pencil'></i> Edit data</a>";
                    }
                  } else {

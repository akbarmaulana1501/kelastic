            ...
            <div class="sidebar-content">
                <div id="sidebar">
                    ...
                    <ul class="side-menu">
                        ...
                        <li>
                            <a href="olahuser.php" class="active">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <p class="fs-5">DATA WARGA KELAS TIC</p>
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="../controller/proses_hapus.php?id=<?php echo $s['id']; ?>&aksi=hapus" class="btn btn-danger" onclick="confirm('hapus data?')"><i class="fa fa-trash"></i></a>
